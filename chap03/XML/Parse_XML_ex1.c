...
int main()
{
  ...
  char pTag[] = "BlogType";    //pTag name which value you want to access
  char pTagValue[100]= {0};    //Buffer to store tag value

  GetXmlTagValue(Response,pTag,pTagValue); //Function to get tag value

  printf("%s",pTagValue); //Print pTag Value
