...
* 1.File I/O
    ...
    *   1.2 fprintf(), fputc(), fputs(), fwrite() 사용 [fprintf](https://github.com/csbyun-data/C-Pro/blob/main/chap03/File/fprintf.c), [fputc](https://github.com/csbyun-data/C-Pro/blob/main/chap03/File/fput.c)
    ```c
    // fprintf.c
