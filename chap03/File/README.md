...
* 1.File I/O
    ...
    *   1.2 fprintf(), fputc(), fputs(), fwrite() 사용 [fprintf.c](https://github.com/csbyun-data/C-Pro/blob/main/chap03/File/fprintf.c), [fputc.c](https://github.com/csbyun-data/C-Pro/blob/main/chap03/File/fputc.c), [fputs.c](https://github.com/csbyun-data/C-Pro/blob/main/chap03/File/fputs.c)
    ```c
    // fprintf.c
