...
static const char *iprompt,*cprompt;    /* input prompts */
...
/* SCN.C */
static int scmp ( const char *str1 , const char *str2 );
static int sncmp ( const char *str1 , const char *str2 , int len );
static void get_id ( void );
static void get_number ( void );
static void get_string ( void );
static int get_rel ( void );
static int getch ( void );
static int getchx ( void );
static int thisch ( void );
...
//    sprintf(cmdline,fmt,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10);
   va_list argptr;
   va_start(argptr, fmt);
   (void) vsprintf(cmdline, fmt, argptr);
   va_end(argptr);
