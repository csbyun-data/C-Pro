Chapter 01. 문법1
  * 1.문법
  	...
  	* 1.2 가변인자, 가변함수, Variadic arguments (va_start, va_list, va_end, va_arg) [Add](https://github.com/csbyun-data/C-Programming/blob/main/chap01/VariableArgument_Add.c)
  * 
```c
#include <stdio.h>
