...
* 6.배열
  *   6.1 배열 초기화
  ...
  ```
* 7.함수
  *  7.1 함수 parameter 전달 ([Call by value](https://github.com/csbyun-data/C-Programming/blob/main/chap01/Function/Call_by_value1.c), [Call by address], Call by reference)
  *  7.2 1D 배열을 전달 [here]()
  ```c
